...
CT001 - Deve ser possível navegar para a área de Pix através do menu carrossel da homepage
...
CT003 - Deve ser possível navegar para a área de transferência através do menu carrossel da homepage
  Dado que o usuário está na tela inicial do Nubank Clone
...
CT004 - Deve ser possível navegar para a área de depósito através do menu carrossel da homepage
  Dado que o usuário está na tela inicial do Nubank Clone
